...
const data = [
    {
        ...
        title: 'Намайг бага байхад болсон аймшигт явдал',
    },
    {
        id: 2,
        image: require('../../../assets/images/image_4.png'),
        title: 'Галзуу эмэгтэй',

    },
    {
        id: 3,
        image: require('../../../assets/images/image_3.jpg'),
        title: 'Сүнсэнд даруулсан',
...
const NewVideo = ({navigation}) => {
    return (
        <View style={styles.container}>
            <View style={styles.headDescContain}>
                <Text style={styles.headText}>Шинээр нэмэгдсэн</Text>
            </View>
